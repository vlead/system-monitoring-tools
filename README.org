...
* Github repository structure
 - There are four different organizations for Virtual-labs Github reposiotires namely
  + vlead - It consists of all the reposiotories for the projetcs currently running in VLEAD
  + openedx-vlead - It It consists of all the reposiotories for the projetcs currently running in VLEAD related to OpnenedX
  + virtual-labs - It consists of all the reposiotories for the projetcs currently running in all the partner institutes of Virtual-Labs
